...
"#line_2 {border-width:1px; border-radius:4px ;border-style: solid; bo"
                        "rder-color: #113e68; background-color: #113e68}\n"
"#BtnDownload { font: 63 12pt \"Segoe UI Semibold\"; }\n"
"#BtnDownload { font: 14pt \"Segoe UI\"; color: #113E68; font-weight: bold; border-style: solid; border-color: #113e68; background-color:rgba(80, 177, 200, 156); border-radius:8px}\n"
"\n"
"\n"
"\n"
"\n"
...
"")
        ...
        self.label_3.setText(u"<html><head/><body><p align=\"center\"><span style=\" font-size:14pt; color:#113e68;\">D</span><span style=\" font-size:14pt; color:#50b1c8;\">ifferential </span><span style=\" font-size:14pt; color:#113e68;\">S</span><span style=\" font-size:14pt; color:#50b1c8;\">cattering</span><span style=\" font-size:14pt;\"><br/></span><span style=\" font-size:14pt; color:#113e68;\">P</span><span style=\" font-size:14pt; color:#50b1c8;\">arameters </span><span style=\" font-size:14pt; color:#113e68;\">Cal</span><span style=\" font-size:14pt; color:#50b1c8;\">culator</span></p></body></html>")
        ...
        self.scrollAreaWidgetContents_7.setGeometry(QRect(0, 0, 282, 690))
        ...
        brush1 = QBrush(QColor(80, 177, 200, 156))
...
#endif
        self.CmbChemical.setPalette(palette1)
        ...
        palette2 = QPalette()
        brush2 = QBrush(QColor(192, 192, 192, 255))
        ...
        self.page_formula.setPalette(palette2)
...
#endif
        self.LneChemicalFormula.setPalette(palette3)
        ...
        self.gridLayout_8.addWidget(self.LneAngle, 2, 0, 1, 1)
        ...
        self.gridLayout_8.addWidget(self.label_14, 1, 0, 1, 1, Qt.AlignVCenter)
...
#endif
        self.label_29.setPalette(palette4)
        ...
        self.BtnDownload.setFont(font4)
...
" (keV)", None))
        ...
        self.BtnCalculate.setText("")
        self.BtnDownload.setText(QCoreApplication.translate("MainWindow", u"Export Results in Excel Format", None))
        self.label_2.setText(QCoreApplication.translate("MainWindow", u"M. B\u00fcy\u00fcky\u0131ld\u0131z, L. Aydinbakar, \"New software for calculating the differential scattering parameters for applications: DSPCal\"", None))
        self.label.setText("")
    # retranslateUi
